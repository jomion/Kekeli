...
// 26 septembre 2026. ChatGPT (fonction serveur « formation-ia-generer ») :
...
(async function () {
  ...
  main.innerHTML = `
    <div class="fk-page"><div class="fk-container" style="max-width:860px">
      ...
      <p class="fk-sous-titre">Décrivez votre formation : ChatGPT prépare le plan puis rédige chaque leçon. Vous relisez et modifiez tout ensuite, avant de la soumettre à KEKELI.</p>
  ...
  try {
    ...
    if (est.configure === false) zoneSolde.innerHTML += '<br><span style="color:var(--f-danger)">⚠️ ChatGPT n\'est pas encore configuré sur KEKELI (clé OpenAI manquante).</span>';
  ...
  form.addEventListener('submit', async ev => {
    ...
    suivi.innerHTML = '<div class="fk-carte" style="margin-top:14px"><div class="fk-chargement">ChatGPT prépare le plan de votre formation (environ une minute)…</div></div>';
    let plan;
    try {
    ...
    suivi.innerHTML = `<div class="fk-carte" style="margin-top:14px">
        ...
        <p style="color:var(--f-muted)">Plan prêt ! ChatGPT rédige maintenant les leçons, module par module. Restez sur cette page (1 à 2 minutes par module).</p>
